...
const { getContractAddresses, getRpcUrl } = require('../config/contracts');

// --- Get addresses and RPC URL from config ---
const { STCORE_ADDRESS, LENDING_POOL_ADDRESS } = getContractAddresses();
const CORE_TESTNET_RPC_URL = getRpcUrl();
