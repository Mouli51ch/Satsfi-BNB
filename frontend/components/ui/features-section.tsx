  ...
  const features = [
    {
      ...
      description:
        "Our Gemini AI continuously monitors BNB DeFi protocols to maximize your BNB yields automatically.",
      ...
      <div className="w-full p-5 mx-auto glass-card shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-800/50 rounded-lg">
              <span className="text-gray-300">BNB testnet Vault</span>
...
export const SkeletonTwo = () => {
  const protocols = [
    ...
    { name: "BNB testnet", logo: "BNB", color: "from-blue-500 to-cyan-500", apy: "6.1%" },
